...
namespace ConfusedGameDev.FiniteRunner.PoliceEscape.Editor
{
    ...
    {
        const string BuildingsFolder = "Assets/99.Test/Jorge/InfiniteCity/Buildings";
        const string RoadReferencePath = "Assets/99.Test/Jorge/InfiniteCity/Roads/road-straight.fbx";
        const string SettingsFolder = "Assets/99.Test/Jorge/InfiniteCity/Settings";
        const string SetPath = SettingsFolder + "/KenneyBuildingSet.asset";
        const string TestSettingsPath = "Assets/99.Test/Jorge/InfiniteCity/Scripts/City/Test/CityTestSettings.asset";
        const string TestBoxSetPath = "Assets/99.Test/Jorge/InfiniteCity/Scripts/City/Test/CityTestBuildingSet.asset";
