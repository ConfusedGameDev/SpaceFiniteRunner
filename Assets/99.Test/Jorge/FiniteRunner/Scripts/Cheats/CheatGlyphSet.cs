...
namespace FiniteRunner
{
    ...
    public class CheatGlyphSet : ScriptableObject
    {
        ...
        public const string KeyboardFolder = "Assets/99.Test/Jorge/FiniteRunner/03.UI/Keyboard & Mouse/Double";

        /// <summary>Where the builder reads the pad glyphs from.</summary>
        public const string GamepadFolder = "Assets/99.Test/Jorge/FiniteRunner/03.UI/Xbox Series/Double";
