...
| D37 | The push | The bar is also the ship's position: as it goes the cruiser's way the ship is **walked toward the edge the cruiser chose**, across `tugPushFraction` of the room, with **sparks grinding between the hulls**. A full bar leaves the ship at the brink; the SHOVE (D29) still finishes it. The bar never drops the ship by itself. |
